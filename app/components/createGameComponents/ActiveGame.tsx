...
const ActiveGame = ({ gameData }: Props) => {
    //placeholder
            ...
            <div className='row flex'>
                ...
                <div className='w-1/2 px-4 py-2 rounded-md'>
                    <div className="w-24 rounded">
                        <img src="https://img.daisyui.com/images/stock/photo-1534528741775-53994a69daeb.jpg" />
                        <div className='text-center'>
                            <p>{gameData.Player_2_name}</p>
                            <Rating rating={gameData.Player_2_Rating} />
                        </div>
                    </div>
                </div>
            </div>
            <Link className='btn w-full btn-accent' href={`/join-game/${gameID}`}>Watch</Link>
        </div>
    )
}
